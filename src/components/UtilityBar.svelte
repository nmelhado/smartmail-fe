...
<div id="accountButtons">
  <Group variant="outlined">
    ...
    {/if}
    {#if exclude != "account"}
      <Button touch color="secondary" on:click={myAccount} variant="outlined"><Label>Manage Account</Label></Button>
    {/if}
    {#if exclude != "my_contacts"}
      <Button touch color="secondary" on:click={contacts} variant="outlined"><Label>My Contacts</Label></Button>
    {/if}
    {#if exclude != "tracking"}
