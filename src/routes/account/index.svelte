<script>
  ...
  import { addressChangeActive, addressStepOneComplete } from '../stores.js';
...
{#if $session.user}
  ...
  <div id="addressBox">
    ...
    {#if todaysAddress != null}
      <Map latitude={todaysAddress.latitude} longitude={todaysAddress.longitude} pinTitle={pinTitle} />
    {/if}
  </div>
